...
'game_name' => "Isle of Trains: All Aboard",

// Game designer (or game designers, separated by commas)
'designer' => 'Seth Jaffee, Dan Keltner',       
...
'tie_breaker_description' => totranslate("The longest train. If still tied, the most points from engine. If still tied players share victory."),
...
'presentation' => array(
    totranslate("Welcome to the Isle of Trains, where all the best conductors come to build and run our famous locomotives. You'll need to get to work right away if you're to be remembered as the greatest operator of all time!"),
    totranslate("Isle of Trains: All Aboard is an engine-building card game in which you will build extravagant engines whilst competing for contracts, cargo, and passengers."),
),
...
'tags' => array( 2, 11, 109, 200, 204, 228 ),
