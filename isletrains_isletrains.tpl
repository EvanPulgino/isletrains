...
<div id="iot_layout">
    <div id="iot_top_panel">
        <div id="iot_progress_island_panel">
        ...
        <div id="iot_cards_panel">
            <div id="iot_deck_display_panel">
                <div id="iot_deck_container">
                    <div id="iot_deck">
                        <div id="iot_deck_counter_container">
    ...
    <div id="iot_player_tableaus">
        ...
        <div id="iot_player_tableau_{PLAYER_ID}" class="iot-player-tableau whiteblock">
            ...
            <div id="iot_player_info_column_{PLAYER_ID}" class="iot-player-info-column">
                ...
                <div id="iot_player_passenger_area_{PLAYER_ID}" class="iot-player-passenger-area">
